...
* Only one SYSCLK_xxx option should be enabled at a time.
*/
...
/* Experimental overclock options, SERDES PLL based. Enable one step at a time. */
// #define SYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE    562500000
// #define SYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE       625000000
// #define SYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE         700000000
     ...
     defined(SYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE) + \
     defined(SYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE) + \
     defined(SYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE)) > 1
#error "Only one SYSCLK_xxx option can be enabled at a time."
#endif
...
#elif defined SYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE
uint32_t SystemClock = SYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE;    /* System Clock Frequency */
uint32_t SystemCoreClock = 140625000;

#elif defined SYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE
uint32_t SystemClock = SYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE;       /* System Clock Frequency */
uint32_t SystemCoreClock = 156250000;

#elif defined SYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE
uint32_t SystemClock = SYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE;         /* System Clock Frequency */
...
#elif defined SYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE
static void SetSYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE( void );
#elif defined SYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE
static void SetSYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE( void );
#elif defined SYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE
static void SetSYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE( void );
...
#elif defined SYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE
    SetSYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE();
#elif defined SYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE
    SetSYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE();
#elif defined SYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE
    SetSYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE();
...
#elif defined SYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE || \
      defined SYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE || \
      defined SYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE

static void SetSYSCLK_SERDES_OverClock_HSE(uint32_t RCC_SERDESPLLMul)
{
  __IO uint32_t StartUpCounter = 0, HSEStatus = 0, FLASH_Temp = 0;
  ...
  *(vu32*)SYS_CFGR0_BASE = tmp;
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    /* Select SERDES PLL mul. SERDES PLL = HSE * mul / 2. */
    RCC->PLLCFGR2 &= (uint32_t)((uint32_t)~(RCC_SERDESPLL_MUL));
    RCC->PLLCFGR2 |= (uint32_t)RCC_SERDESPLLMul;

    /* Enable SERDES PLL */
    RCC->CTLR |= (uint32_t)RCC_SERDES_PLLON;

    /* Wait till SERDES PLL is ready */
    while ((RCC->CTLR & (uint32_t)RCC_SERDES_PLLRDY) != (uint32_t)RCC_SERDES_PLLRDY)
    {
    }

    /* Select SERDES_PLL Clock as SYSPLL clock source */
    RCC->PLLCFGR &= (uint32_t)((uint32_t)~(RCC_SYSPLL_GATE));
    RCC->PLLCFGR &= (uint32_t)((uint32_t)~(RCC_SYSPLL_SEL));
    RCC->PLLCFGR |= (uint32_t)((uint32_t)(RCC_SYSPLL_SERDES));

    /* Wait till SERDES is used as system clock source */
    while ((RCC->PLLCFGR & (uint32_t)RCC_SYSPLL_SEL) != (uint32_t)RCC_SYSPLL_SERDES)
    {
    }
    ...
    /* Select FLASH clock frequency. DIV4 is safer for overclock tests. */
    FLASH_Temp = FLASH->ACTLR;
    FLASH_Temp &= ~((uint32_t)0x3);
...
#ifdef SYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE

/*********************************************************************
 * @fn      SetSYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE
 *
 * @brief   Sets System clock frequency to 562.5MHz.
 *          Sets V5F Core clock frequency to 562.5MHz.
 *          Sets V3F Core clock frequency to 140.625MHz.
 *          configure HCLK prescalers.
 *
 * @return  none
 */
static void SetSYSCLK_562M5_CoreCLK_V5F_562M5_V3F_140M625_HSE(void)
{
  SetSYSCLK_SERDES_OverClock_HSE(RCC_SERDESPLL_MUL45);
}

#elif defined SYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE

/*********************************************************************
 * @fn      SetSYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE
 *
 * @brief   Sets System clock frequency to 625MHz.
 *          Sets V5F Core clock frequency to 625MHz.
 *          Sets V3F Core clock frequency to 156.25MHz.
 *          configure HCLK prescalers.
 *
 * @return  none
 */
static void SetSYSCLK_625M_CoreCLK_V5F_625M_V3F_156M25_HSE(void)
{
  SetSYSCLK_SERDES_OverClock_HSE(RCC_SERDESPLL_MUL50);
}

#elif defined SYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE

/*********************************************************************
 * @fn      SetSYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE
 *
 * @brief   Sets System clock frequency to 700MHz.
 *          Sets V5F Core clock frequency to 700MHz.
...
static void SetSYSCLK_700M_CoreCLK_V5F_700M_V3F_175M_HSE(void)
{
  SetSYSCLK_SERDES_OverClock_HSE(RCC_SERDESPLL_MUL56);
}
